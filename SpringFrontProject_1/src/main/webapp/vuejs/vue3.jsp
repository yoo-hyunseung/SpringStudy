...
<body>
<div class="container">
	<div class="text-center">일일 박스오피스Vue(디렉티브:v-for 제어문) </div>
	<div class="row">
	<table class="table">
		<tr>
			<td>
				<input type="text" size="30" class="input-sm" v-model="msg" refs="msg">
		...
		<table class="table">
			...
			<tbody>
				<tr v-for="vo in movie">
					...
					<img alt="" :src="'https://www.kobis.or.kr'+vo.thumbUrl" style="width: 30px;height: 30px">
					</td>
					<td>{{vo.movieNm}}</td>
...
new Vue({
	...
	beforeCreate:function(){
		console.log('beforeCreate:function -> vue 객체를 생성하기전...')
		// componentWillCreate (React)
	},
	create:function(){
		console.log('create:function -> vue가 생성완료 ...')
		// componentDidCreate (React)
	},
	beforeMount:function(){
		console.log('beforeMount:function -> 가상 메모리(가상DOM)에 올리기전 ...')
	},
	mounted:function(){
		console.log('mounted:function -> 가상 메모리에 HTML올리기 완료 ...')
		/* $(function()), window.onload */
		/* 가상 돔 / 실제돔을 비교해서 변경 -> diff */
		/* 가장 많이 사용되는 상태 (서버에서 데이터를 읽어오는 경우) */
	},
	beforeUpdate:function(){
		console.log('beforeUpdate:function -> 상태가 변경(데이터값 변경)되기 직전상')
		// 멤버 변수 설정 : react : state , Vue -> data, -> data를 다른 메소드에서 변경시에는 this.
	},
	updated:function(){
		console.log('updated:function -> 데이터 변경이나 수정이 완료된 상태 -> mounted를 재호출')
	},
	beforeDestroy:function(){
		console.log('beforeDestroy:function -> 메모리 해제 전 상태...')
	},
	destroyed:function(){
		console.log('destroyed:function 화면이 변경 -> Vue 객체 해제...')
	},
	methods:{
		find:function(){
			if(this.msg===''){
