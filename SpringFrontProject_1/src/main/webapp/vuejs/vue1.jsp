...
<body>
<!-- 
	1. VueJS의 생명 주기 -> vue3(React), Vuex(MVC)
	   beforeCreate
	   created
	   ------------ 뷰 객체 생성 
	   beforeMount
	...
	2. 디렉티브
	    => 제어문
	       ...
	       v-model 양방향통신
	    => 이벤트
	       v-on:click , <button vo-on:click="aaa()">
	       -con:change
	    => 양방향 통신(Vue) / 단방향 통신(React)
	       ----------AngularJS에서 파생 -> GO / C# / JAVA
	3. 컴포넌트 : 재사용
	...
	6. Vue생성
	   <script>
	   		new Vue({
	   			el :.container => 제어 영역 => class =".container"
	   			data:{
	   				=> 멤버변수 (Vue에서 제어하는 변수) 
	   				a:[] => Spring에서 전동 => ArrayList -> JSONArray
	   				b:{} => VO (JSONObject) 
	   				c:true => boolean
	   				d:'' => String
	   				e:0 => 정수/실수
	   ...
	   <img src="{{}}"> -> 오류 발생
	   <img :src="poster">
	   => : => <input type="text" :value="id"> => v-bind: 생략가능 :만 사용할 수 있다.
 -->
 <div class="container">
 	<div class="row">
 	<!-- 양방향 통신 : 입력값을 받아서 출력을 하는 역할 -->
