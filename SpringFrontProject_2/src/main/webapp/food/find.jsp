...
<body>
  <div class="container-fluid">
   <div class="row">
     <input type=text ref="fd" size=30 class="input-sm" v-model="fd"> <!-- 설정한 변수를 바로 넣어줌 -->
  ...
  new Vue({
	  ...
	  // 시작과 동시에 데이터를 읽어서 출력
	  // Callback => 시스템에 의해 자동으로 호출되는 함수 => 생명주기 함수
	  // window.onload => $(function(){}) => conponentDidMount => useEffect()
	  mounted:function(){
		this.send();
	  },
	  // 멤버 함수 => 사용자 정의
